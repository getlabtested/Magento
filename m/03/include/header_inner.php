...
<head>
	...
	<link href="http://c260200.r0.cf1.rackcdn.com/03/css/style.css" media="handheld, screen" rel="stylesheet" type="text/css" />
...
<div id="wrap">
	...
	<div id="header">
		<div id="logo"><a href="<?php echo ROOT_WWW; ?>" title="Home | getSTDtested.com">STD Testing</a></div>
		<a href="<?php echo ROOT_WWW; ?>" id="back-home">Back to STD Testing Home</a>
		<h1><?php echo get_title(basename($_SERVER['REQUEST_URI'], ".php"));?></h1>
	</div>
