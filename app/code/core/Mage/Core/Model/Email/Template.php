...
class Mage_Core_Model_Email_Template extends Mage_Core_Model_Template
{
    ...
    public function sendTransactional($templateId, $sender, $email, $name, $vars=array(), $storeId=null)
    {
		...
		if ($templateId != 'customer_create_account_email_template') {
		...
		//Mage::Log($templateId);
		//Mage::Log(print_r($sender,true));
		//Mage::Log(print_r($email,true));
		//Mage::Log($name);
		//Mage::Log(print_r($vars,true));
        ...
        if (!is_array($sender)) {
            ...
            $this->setSenderName('GetLabTested');
            $this->setSenderEmail('info@getlabtested.net');
        }
