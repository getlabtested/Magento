...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function addStatusHistoryComment($comment, $status = false)
    {
        ...
        $order_vendors = Mage::helper('ppmd_tests/vendors')->getProductVendors($this->getItemsCollection());
        if (in_array('medivo', $order_vendors))
        {
            Mage::getModel('medivo/medivo')->orderComment($this->getId(),$comment,'LetterLog');
        }
