...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
    ...
    public function loginAction()
    {
        if ($this->_getSession()->isLoggedIn()) {
            //$this->_redirect('*/*/');
            $this->_redirectUrl(Mage::getUrl('my-results'));
            return;
        }
    ...
    {
        if ($this->_getSession()->isLoggedIn()) {
            $this->_redirectUrl(Mage::getUrl('my-results',array('_secure'=>true)));
            //$this->_redirect('*/*/');
            return;
        }
...
// 
        ...
        //$this->_redirect(Mage::getUrl('my-results', array('_secure'=>true)));
		
		$this->_redirectUrl(Mage::getUrl('my-results',array('_secure'=>true)));
		
		return;
		
        //$this->_redirect('my-results');
    }
        ...
        if ($email) {
            ...
            if ($customer->getId()) {
                try {
                    ...
                    $this->_getSession()->addSuccess($this->__('A new password has been sent to your Email address.'));
