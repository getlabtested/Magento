...
//        $shortlink = $this->googl_generator($page_url);
        ...
        if (in_array("shr-facebook", $bookmarksarray))
            ...
            $blist.='<li class="shr-facebook">
                    ...
                    <a onclick="window.open(this.href,\'sharer\',\'toolbar=0,status=0,width=626,height=436\'); return false;" title="Share this on Facebook" rel="nofollow" href="' . $href . '?v=1&title=' . $title . '&amp;link=' . $link . '&amp;notes=' . $notes . '&amp;short_link=' . $shortlink . '&amp;apitype=' . $apitype . '&amp;apikey=' . $apikey . '&amp;source=' . $source . '&amp;template=&amp;service=5&amp;tags=' . $tags . '&amp;ctype=">Facebook</a>
        ...
        if (in_array("shr-googlebuzz", $bookmarksarray))
            ...
            $blist.='<li class="shr-googlebuzz">
                    ...
                    <a onclick="window.open(this.href,\'sharer\',\'toolbar=0,status=0,width=826,height=436\'); return false;" title="Post on Google Buzz" class="external" rel="nofollow" href="' . $href . '?v=1&title=' . $title . '&amp;link=' . $link . '&amp;notes=' . $notes . '&amp;short_link=' . $shortlink . '&amp;apitype=' . $apitype . '&amp;apikey=' . $apikey . '&amp;source=' . $source . '&amp;template=&amp;service=257&amp;tags=' . $tags . '&amp;ctype=" target="_blank">Google</a>
        ...
        if (in_array("shr-mail", $bookmarksarray))
            ...
            $blist.='<li class="shr-mail">
                    ...
                    <a title="Email this to a friend?" class="external" rel="nofollow" href="' . $href . '?v=1&title=Hello%20world%21&amp;link=' . $link . '&amp;notes=' . $notes . '&amp;short_link=' . $shortlink . '&amp;apitype=' . $apitype . '&amp;apikey=' . $apikey . '&amp;source=' . $source . '&amp;template=&amp;service=201&amp;tags=' . $tags . '&amp;ctype=" target="_blank">Email</a>
        ...
        if (in_array("shr-twitter", $bookmarksarray))
            ...
            $blist.='<li class="shr-twitter">
                    ...
                    <a onclick="window.open(this.href,\'sharer\',\'toolbar=0,status=0,width=626,height=436\'); return false;" title="Tweet This!" class="external" rel="nofollow" href="' . $href . '?v=1&title=' . $title . '&amp;link=' . $link . '&amp;notes=' . $notes . '&amp;short_link=' . $shortlink . '&amp;apitype=' . $apitype . '&amp;apikey=' . $apikey . '&amp;source=' . $source . '&amp;template=%24%7Btitle%7D+-+%24%7Bshort_link%7D+via+%40' . $source . '&amp;service=7&amp;tags=' . $tags . '&amp;ctype=" target="_blank">Twitter</a>
...
//                    </li>';
        ...
        if (in_array("shr-digg", $bookmarksarray))
            ...
            $blist.='<li class="shr-digg">
                    ...
                    <a onclick="window.open(this.href,\'sharer\',\'toolbar=0,status=0,width=626,height=436\'); return false;" title="Digg this!" class="external" rel="nofollow" href="' . $href . '?v=1&title=' . $title . '&amp;link=' . $link . '&amp;notes=' . $notes . '&amp;short_link=' . $shortlink . '&amp;apitype=' . $apitype . '&amp;apikey=' . $apikey . '&amp;source=' . $source . '&amp;template=&amp;service=3&amp;tags=' . $tags . '&amp;ctype=" target="_blank">Digg</a>
