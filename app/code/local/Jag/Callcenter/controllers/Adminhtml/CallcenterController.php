...
class Jag_Callcenter_Adminhtml_CallcenterController extends Mage_Adminhtml_Controller_action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('callcenter/items')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Call Center'), Mage::helper('adminhtml')->__('Create Order'));
		return $this;
	}   
