 ...
 */
class Jag_Userdashboard_AccountController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    public function editPostAction()
    {
        if (!$this->_validateFormKey()) {
            return $this->_redirect('/my-results');
        }
		   ...
		   /*address section goes here */
            ...
            try {
                ...
                if (count($errors) === 0) {
                    ...
                    $this->_redirectSuccess(Mage::getUrl('/my-results', array('_secure'=>true)));
                    return;
                } else {
