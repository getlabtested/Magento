<?php
class Jag_Localepage_Block_Dynamic extends Mage_Core_Block_Template
{
    ...
    public function getCityList() {
    	...
    	$cityList = Mage::getModel('localepage/dynamic')->getCollection()
    		->addFieldToFilter('type',array('eq'=>'normal'));
    ...
    public function getStateList() {
    	...
    	$stateList->addFieldToFilter('type',array('eq'=>'normal'));
