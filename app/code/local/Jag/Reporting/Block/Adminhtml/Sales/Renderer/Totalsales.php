...
class Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalsales extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	public function render(Varien_Object $row) {
		...
		$collection->addFieldToFilter('main_table.updated_at',array('lt'=>$to));
   		...
   		//echo $sales->getSelect()->__toString();
		...
		$csales->addFieldToFilter('affiliate_id',array('eq'=>$aff));
		$csales->addFieldToFilter('ppmd_rep',array('neq'=>99));
