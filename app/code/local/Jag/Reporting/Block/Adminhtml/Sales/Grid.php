...
class Jag_Reporting_Block_Adminhtml_Sales_Grid extends Mage_Adminhtml_Block_Widget_Grid
...
*/
  ...
  protected function _prepareCollection()
  {
    ...
    $affiliates = Mage::getModel('affiliates/affiliates')->getCollection();
   		$affiliates->addFieldToFilter('callcenter',array('eq'=>1));
		$affiliates->getSelect()->order(array('referral_id ASC'));
		
		//echo $affiliates->getSelect()->__toString();
		
		$affArr = array();
   		
		foreach ($affiliates->getItems() as $affiliate) {
				
			$affArr[] = $affiliate->getReferralId();
...
*/
      ...
      $this->addColumn('authorizenet', array(
          ...
          'index'     => 'authorizenet',
          'type'      => 'text',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Methods',
      ));
      ...
      $this->addColumn('sales', array(
          ...
          'filter'   => false,
          'index'     => 'sales',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalsales',
      ));
      ...
      $this->addColumn('conversion', array(
	   ...
	   $this->addColumn('total_revenue', array(
          ...
          'filter'   => false,
          'index'     => '',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalrevenue',
      ));
      ...
      $this->addColumn('total_paid', array(
          ...
          'filter'   => false,
          'index'     => '',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalpaid',
      ));
       ...
       $this->addColumn('total_refunded', array(
          ...
          'filter'   => false,
          'index'     => '',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalrefunded',
      ));
      ...
      $this->addColumn('total_cash', array(
          ...
          'filter'   => false,
          'index'     => '',
          'renderer'  => 'Jag_Reporting_Block_Adminhtml_Sales_Renderer_Totalcash',
      ));
