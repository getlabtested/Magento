...
class Jag_Reporting_Block_Adminhtml_Rep_Renderer_Totalnow extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	...
	public function render(Varien_Object $row) {
		...
		$sales->addFieldToFilter('sales_flat_order_payment.method',array('eq'=>'authorizenet'));
