...
class Jag_Reporting_Block_Adminhtml_Report_Filter_Form_Order extends Mage_Sales_Block_Adminhtml_Report_Filter_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->setFieldVisibility('sales_report_report_type',false);
