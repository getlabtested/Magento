 ...
 */
class Jag_Reporting_Adminhtml_AfftwoController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Admin session model
     *
    ...
    {
        $this->loadLayout();
           // ->_addBreadcrumb(Mage::helper('reports')->__('Reports'), Mage::helper('reports')->__('Reporting'))
...
*/
        ...
        $gridBlock = $this->getLayout()->getBlock('adminhtml_afftwo.grid');
    ...
    public function exportCsvAction()
    {
        ...
        $content    = $this->getLayout()->createBlock('reporting/adminhtml_sales_grid')
            ->getCsv();
