...
try {
	...
	$myOrder->getPayment()->addTransaction(Mage_Sales_Model_Order_Payment_Transaction::TYPE_CAPTURE,null,false,'PNM Transaction PAID');
								
	//mail('ljrweb@gmail.com','success pnm add transaction',$myOrder->getId());
							
} catch(Exception $e) {
								
	///mail('ljrweb@gmail.com','failed pnm add transaction',$myOrder->getId());
