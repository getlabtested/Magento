...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        $('opc-billing').style.display = 'block';
        $('opc-billing').addClassName('allow');
        this.accordion.openSection($('opc-billing'));
        $('checkout-step-login').style.display = 'block';
        
        $('opc-payment').style.display = 'block';
        $('opc-payment').addClassName('allow');
        this.accordion.openSection($('opc-payment'));
        $('checkout-step-billing').style.display = 'block';
