...
************************************************************************************/
    ...
    define('VBSEO_LICENSE_CODE',            'c5a6b77070e919f06a5ca9263ff65250');


    // ****** CONFIG PANEL PASSWORD ******
    define('VBSEO_ADMIN_PASSWORD',          'e004b4e9c5ecb444d269d8a6fbcb860d');
...
//\'calendar/\?(.+)\' => \'calendar.php?$1\'';
    ...
    $vbseo_images_dim = array('images/misc/lightbox_progress.gif' => array(300,200),
...
'images/misc/cross.png' => array(16,16),
...
'images/misc/album_folder_top_bg.gif' => array(1,6),
...
'images/misc/tick.png' => array(16,16),
...
'images/misc/album_folder_tab.png' => array(37,6),
...
'images/misc/album_folder_bg.png' => array(1,100),
...
'images/misc/magnifier.png' => array(16,16),
'images/misc/im_skype.gif' => array(17,17),
'images/misc/trashcan.gif' => array(17,21),
'images/misc/unknown_sg.gif' => array(80,80),
...
'images/attach/attach.gif' => array(16,16),
...
'');
    ...
    define('VBSEO_BOOKMARK_CUSTOM',        1);
    ...
    define('VBSEO_BOOKMARK_SERVICES',      '// Un-comment the patterns below (remove \'//\' at the beginning) to enable desired Bookmarking Services or add your own!|http://www.facebook.com/share.php?u=%url%,images/vbseo/facebook.gif,Share on Facebook,Share on Facebook|//http://www.spurl.net/spurl.php?title=%title%&url=%url%,images/vbseo/spurl.gif,Spurl this Thread!,Spurl this Post!|http://reddit.com/submit?url=%url%&title=%title%,images/vbseo/reddit.gif,Reddit!,Reddit! |//http://www.mister-wong.de/index.php?action=addurl&bm_url=%url%&bm_description=%title%,images/vbseo/mister-wong.gif,Wong this Thread!,Wong this Post!');
