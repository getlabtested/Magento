...
if (strlen('d0c6c20c6066926885a104255f5dd5cb') == 32)
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', 'd0c6c20c6066926885a104255f5dd5cb');
}
else
{
	/**
	* @ignore
	*/
	define('CUSTOMER_NUMBER', md5(strtoupper('d0c6c20c6066926885a104255f5dd5cb')));
}
