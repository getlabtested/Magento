...
echo date('D',time()-21600);

$data = $api->data($idg, '', 'ga:visits,ga:pageviews,ga:newVisits,ga:visitors', false, $thisWeekGa, $nextWeekGa, 1000000, 1, $filters,null);

$visitorCount = $data['ga:visitors'];

$tv = $visitorCount;

$phone = getCalls($thisWeek,$nextWeek);
	
$sales = makeReport($thisWeek,$nextWeek);

$ref = getRefunds($thisWeek,$nextWeek);
...
$query = 'select SUM(a.lab_revenue) as total 
	...
	$data = $api->data($idg, '', 'ga:visits,ga:pageviews,ga:newVisits,ga:visitors', false, $lastSundayGa, $thisWeekGa, 1000000, 1, $filters,null);
