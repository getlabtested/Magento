...
$data = $api->data($idg, '', 'ga:visits,ga:pageviews,ga:newVisits,ga:visitors', false, '2011-11-01', "2011-12-01", 10, 1, $filters);
$visitorCount = $data['ga:visitors'];

$tv = $visitorCount;

$phone = getCalls($lastMonth,$curMonth);
	
$sales = makeReport($lastMonth,$curMonth);

$ref = getRefunds($lastMonth,$curMonth);
